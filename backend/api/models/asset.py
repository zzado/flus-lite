...
class AssetAbstractModel(models.Model):
    ...
    # regacy field
    full_code = models.CharField('자산전체코드', null=True, max_length=100)
...
class Asset(AssetAbstractModel, HardwareAssetModel, ApplicationAssetModel):
    ...
    progress = models.PositiveSmallIntegerField('진행단계',
    choices=((1, '초기단계(1)'),(2, '스캔준비(2)'),(3, '스캔완료(3)'),(4, '확인점검(4)'),(5, '점검완료(5)'),),default=1, null=True)
