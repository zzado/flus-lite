# Generated by Django 3.2.9 on 2022-01-09 08:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area_alias', models.CharField(choices=[('FISM', '정보보호관리체계'), ('SRV', '서버'), ('DBM', '데이터베이스'), ('INF', '네트워크 인프라'), ('NET', '네트워크 장비'), ('ISS', '정보보호시스템'), ('WEB', '웹 애플리케이션'), ('MOB', '모바일 애플리케이션'), ('HTS', 'HTS')], max_length=10, verbose_name='분야')),
                ...
                ('full_code', models.CharField(max_length=100, null=True, unique=True, verbose_name='자산전체코드')),
                ...
                ('is_server', models.BooleanField(choices=[(False, '아니오'), (True, '예')], default=True, verbose_name='서버측 점검 여부')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assessors', models.ManyToManyField(blank=True, to=settings.AUTH_USER_MODEL, verbose_name='프로젝트 참여자')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auto_result', models.CharField(blank=True, default='', max_length=10, verbose_name='자동분석결과')),
                ...
                ('asset', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='vuls', to='api.asset')),
                ('project', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='vuls', to='api.project')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(upload_to=api.models.upload_file.get_referfile_upload_to, verbose_name='참고파일')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('result', models.CharField(default='Y', max_length=10, verbose_name='취약여부')),
                ('auto_result', models.CharField(blank=True, default='', max_length=10, verbose_name='자동판단결과')),
                ('point', models.TextField(blank=True, default='', verbose_name='취약항목')),
                ...
                ('vulnerability', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pocs', to='api.vulnerability')),
            ],
            options={
                'ordering': ['pk'],
            },
        ...
        migrations.AddField(
            model_name='asset',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assets', to='api.project', verbose_name='프로젝트'),
        ),
    ]
