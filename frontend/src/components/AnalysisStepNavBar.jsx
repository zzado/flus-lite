...
export default function AnalysisStepNavBar(){
    return (
      <div style={{float: 'left', width: '100%'}}>
        <ul className="nav nav-tabs">
          <li className="menu-tabs"><Button className="menu-tabs-button active" ><span className="badge badge-sm">1</span> 자산 관리</Button></li>
