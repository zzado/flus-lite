    ...
    return (
      <div style={{float: 'left', width: '100%'}}>
        <ul className="nav nav-tabs">
          <li className="menu-tabs"><Button as={Link} to={`/w/${projectId}/${areaAlias}/step1`} style={ step === 1? {backgroundColor:'#007bff', color: 'white'} : {} } className="menu-tabs-button" ><span className="badge badge-sm">1</span> 취약점 분석</Button></li>
