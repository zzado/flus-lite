...
export default function POCInfoTable(props){
  const { pocListDispatch, pocList } = props;
  ...
  const newPocData = useMemo( ()=> ({id:0, result: 'Y', auto_result: 'Y', found_date: currentDate, is_reported: false, is_new: true, is_patched: false, note:'', point: '', reported_date: '', patched_date: ''}), []);
